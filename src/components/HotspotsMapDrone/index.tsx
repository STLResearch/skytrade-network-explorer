...
export function HotspotsMapDrone() {
  ...
  return (
    ...
    >
      ...
      {secondTab && <NetworkCoverageLayer layer={networkLayers.custom} />}
      {/* <Marker longitude={78} latitude={22} anchor="bottom" >
        <img src="./camera-drone.png" width={30} height={30}/>
      </Marker> */}
